...
_PLOT_KEYWORDS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("Modified Gompertz Kinetics", ("gompertz", "cumulative response", "growth kinetics", "production kinetics")),
...
def _column_score(name: str, role: str) -> float:
    ...
    if role == "x":
        ...
        keys = ("response", "output", "target", "result", "yield", "rate", "intensity", "absorb", "signal", "conversion", "removal", "efficiency", "power", "score")
    else:
